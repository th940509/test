...
<body>
	...
	<table style="width: 700px; text-align: center" border="1">
		...
		<tr>
			<td>
				<input type="button" value="수정하기" onclick="location.href='06_bUpdate1.jsp?num=<%=bdto.getNum() %>'">
				<input type="button" value="삭제하기" onclick="location.href='08_bDelete1.jsp?num=<%=bdto.getNum() %>'">
				<input type="button" value="목록보기" onclick="location.href='04_bList1.jsp'">
			</td>
		</tr>
	</table>
</body>
